...
class TestTaskStatus:
    ...
    async def test_get_task_status(self, async_client, sample_pdf):
    ...
    async def test_task_has_doc_id(self, async_client, sample_pdf):
        up_resp = await async_client.post(
            "/api/v1/upload",
    ...
    async def test_task_has_filename(self, async_client, sample_pdf):
        up_resp = await async_client.post(
            "/api/v1/upload",
...
class TestTaskLifecycle:
    ...
    async def test_task_completes_after_upload(self, async_client, sample_pdf):
        up_resp = await async_client.post(
            "/api/v1/upload",
    ...
    async def test_task_has_timestamps(self, async_client, sample_pdf):
        up_resp = await async_client.post(
            "/api/v1/upload",
    ...
    async def test_completed_task_has_no_error(
...
class TestActiveTaskForDoc:
    """Test active task lookup by document."""

    async def test_get_active_task_for_doc(self, async_client, sample_pdf):
        up_resp = await async_client.post(
            "/api/v1/upload",
        ...
        resp = await async_client.get(
            f"/api/v1/tasks/active-for-doc/{doc_id}"
        )
        assert resp.status_code == 200
        body = resp.json()
    ...
    async def test_no_active_task_after_completion(
        self, async_client, sample_pdf
    ):
        up_resp = await async_client.post(
            "/api/v1/upload",
...
class TestTaskCancel:
    ...
    async def test_cancel_completed_task(self, async_client, sample_pdf):
        up_resp = await async_client.post(
            "/api/v1/upload",
