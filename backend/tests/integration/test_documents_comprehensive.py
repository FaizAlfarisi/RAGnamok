...
class TestDocumentList:
    ...
    async def test_list_documents_with_limit(self, async_client, sample_pdf):
        for i in range(3):
            await async_client.post(
                "/api/v1/upload?auto_index=false",
                files={
                    "file": (f"doc{i}.pdf", sample_pdf, "application/pdf")
                },
            )
    ...
    async def test_list_documents_with_offset(self, async_client, sample_pdf):
        for i in range(3):
            await async_client.post(
                "/api/v1/upload?auto_index=false",
                files={
                    "file": (f"offset{i}.pdf", sample_pdf, "application/pdf")
                },
            )

        resp_all = await async_client.get("/api/v1/documents?limit=10")
        resp_offset = await async_client.get(
            "/api/v1/documents?limit=1&offset=1"
        )
...
class TestDocumentGet:
    ...
    async def test_get_document_by_id(self, async_client, sample_pdf):
...
class TestDocumentDelete:
    ...
    async def test_soft_delete_sets_deleted_at(self, async_client, sample_pdf):
        up_resp = await async_client.post(
            "/api/v1/upload?auto_index=false",
    ...
    async def test_double_delete_returns_404(self, async_client, sample_pdf):
        up_resp = await async_client.post(
            "/api/v1/upload?auto_index=false",
    ...
    async def test_deleted_document_excluded_from_list(
        self, async_client, sample_pdf
    ):
        up_resp = await async_client.post(
            "/api/v1/upload?auto_index=false",
    ...
    async def test_delete_cancels_active_task(self, async_client, sample_pdf):
        up_resp = await async_client.post(
            "/api/v1/upload",
...
class TestDocumentToggle:
    """Test document enable/disable toggle."""

    async def test_toggle_off_then_on(self, async_client, sample_pdf):
        up_resp = await async_client.post(
            "/api/v1/upload",
    ...
    async def test_toggle_returns_correct_doc_id(
        self, async_client, sample_pdf
    ):
        up_resp = await async_client.post(
            "/api/v1/upload?auto_index=false",
...
class TestDocumentReindex:
    """Test re-indexing completed documents."""

    async def test_reindex_completed_document(self, async_client, sample_pdf):
        up_resp = await async_client.post(
            "/api/v1/upload",
        ...
        doc_before = (
            await async_client.get(f"/api/v1/documents/{doc_id}")
        ).json()
        chunks_before = doc_before["chunk_count"]
    ...
    async def test_index_returns_task_id(self, async_client, sample_pdf):
        up_resp = await async_client.post(
            "/api/v1/upload?auto_index=false",
...
class TestDocumentStatusTransitions:
    ...
    async def test_status_uploaded_to_completed(self, async_client, sample_pdf):
        up_resp = await async_client.post(
            "/api/v1/upload",
    ...
    async def test_status_uploaded_without_index(
        self, async_client, sample_pdf
    ):
        up_resp = await async_client.post(
            "/api/v1/upload?auto_index=false",
    ...
    async def test_enabled_true_after_completion(
        self, async_client, sample_pdf
    ):
        up_resp = await async_client.post(
            "/api/v1/upload",
